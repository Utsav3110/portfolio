...
import CV from '../../assets/UTSAV_GANGANI.pdf';
  ...
  return (
    <section id="hero" className={styles.container}>
      ...
      <div className={styles.info}>
        ...
        <span>
          <a href="https://x.com/UtsavGangani" target="_blank">
            <img src={twitterIcon} alt="Twitter icon" />
          </a>
          <a href="https://github.com/Utsav3110" target="_blank">
          ...
          <a href="https://leetcode.com/u/utsav31/" target="_blank">
            <img src={leetcodeIcon} alt="Linkedin icon" />
          </a>
        </span>
        <p className={styles.description}>
          I am an aspiring Full Stack Developer, a lifelong learner, and a
